...
public:
  ...
  static string DayShortName(short Day, short Month, short Year) {
    ...
    static clsDate GetDateFromDayOrderInYear(short DateOrderInYear,
                                             short Year) {
    ...
    // above no need to have nonstatic function for the object because it does
    // not depend on any data from it.
    ...
    static bool IsBusinessDay(clsDate Date) {
      ...
      */
      ...
      // shorter method is to invert the IsWeekEnd: this will save updating
      // code.
